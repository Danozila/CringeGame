...
playerChoiceText = textFont.render('Choose Player(1-first, 2-second)', True, (0, 0, 0))
gmChoiceText1 = textFont.render('Choose game mode', True, (0, 0, 0))
gmChoiceText2 = textFont.render('(1-PvP, 2 - PvE)', True, (0, 0, 0))
loadingText = textFont.render('Loading...', True, (0, 0, 0))
numFont = pygame.font.Font(None, cellSize)
winText2 = textFont.render('Press any key to restart', True, (0, 0, 0))
...
while running:
    if scene == "Game mode choice":
        ...
        DisplayField(field, cells, cellSize, x0, y0, numFont)
        if gameMode == "PvE" and player == computer:
            playerText = textFont.render("Player: " + str(player) + "(Computer)", True, (0, 0, 0))
        else:
            playerText = textFont.render("Player: " + str(player), True, (0, 0, 0))
        ...
        if gameEnd:
            ...
            if player != computer and gameMode == "PvE":
                winText1 = textFont.render("Player " + str(player % 2 + 1) + "(Computer)" + " win", True, (0, 0, 0))
            else:
                winText1 = textFont.render("Player " + str(player % 2 + 1) + " win", True, (0, 0, 0))
    elif scene == "Win":
        screen.fill((255, 255, 255))
